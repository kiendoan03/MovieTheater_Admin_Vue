...
<template>
  ...
  <div class="row">
    <div class="col-12">
      <RouterLink to="/admin/movie/create" type="button" class="btn btn-outline-light my-4" tabindex="-1" role="button" aria-disabled="true">
          ...
          <tr v-for="(movie, index) in movies" :key="movie.id">
            ...
            <td v-else-if="formatDate(movie.endDate) < today" class="col-1">
              ...
              <td class="col-1">
                ...
                <td class="col-2">
                  <RouterLink :to="'/admin/movie/edit/' + movie.id"  type="button" class="btn btn-outline-light my-1" tabindex="-1" role="button" aria-disabled="true">
