...
<template>
  <div>
    ...
    <RouterLink to="/admin/staff/create" type="button" class="btn btn-outline-light my-4" tabindex="-1" role="button" aria-disabled="true">
        ...
        <table class="table table-dark table-hover">
            ...
            <tbody class="table-group-divider">
                <tr v-for="(staff, index) in staffs" :key="staff.id">
                    ...
                    <td class="col-2">
                        <RouterLink :to="'/admin/staff/edit/' + staff.id" type="button" class="btn btn-outline-light my-1" tabindex="-1" role="button" aria-disabled="true">
