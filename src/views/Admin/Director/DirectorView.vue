...
<template>
  <div>
    ...
    <RouterLink to="/admin/director/create" type="button" class="btn btn-outline-light my-4" tabindex="-1" role="button" aria-disabled="true">
        ...
        <table class="table table-dark table-hover">
            ...
            <tbody class="table-group-divider">
                <tr v-for="(director, index) in directors" :key="director.id">
                    ...
                    <td class="col-2">
                        <RouterLink :to="'/admin/director/edit/' + director.id" type="button" class="btn btn-outline-light my-1" tabindex="-1" role="button" aria-disabled="true">
