...
<template>
  <main>
    ...
    <RouterLink to="/admin/schedule/create" type="button" class="btn btn-outline-light my-4" tabindex="-1" role="button" aria-disabled="true">
      ...
      <table class="table table-dark table-hover">
        ...
        <tbody>
          <tr v-for="(schedule, index) in schedules" :key="schedule.id">
            ...
            <td class="col-2">
              <RouterLink :to="'/admin/schedule/edit/' + schedule.id" type="button" class="btn btn-outline-light my-1" tabindex="-1" role="button" aria-disabled="true">
                <font-awesome-icon :icon="['fas', 'pen-to-square']" />
              </RouterLink> 
              <RouterLink :to="'/admin/schedule/detail/' + schedule.id" type="button" class="btn btn-outline-light my-1 mx-1" tabindex="-1" role="button" aria-disabled="true">
